                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">ANMEX</h4>
                                    <div class="row mt-3">
                            ...
                            <div class="card-body">
                                <form wire:submit.prevent='store'>
                                    ...
                                    <div class="input-group input-group-outline mt-3 @if(strlen($email ?? '') > 0) is-filled @endif">
                                        ...
                                        <input wire:model='email' type="email" autocomplete="off" class="form-control">
                                    </div>
                                    @error('email')
                                    ...
                                    <div class="input-group input-group-outline mt-3 @if(strlen($password ?? '') > 0) is-filled @endif">
                                        ...
                                        <input wire:model="password" type="password" autocomplete="off"  class="form-control"
                                             >
                                    </div>
                                    @error('password')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    ...
                                    <div class="form-check form-switch d-flex align-items-center my-3">
                                        ...
                                        <label class="form-check-label mb-0 ms-2" for="rememberMe">Recordarme</label> --}}
                                    </div>
