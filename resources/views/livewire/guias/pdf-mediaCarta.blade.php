    ...
    @if ($guia->id_externo != null)
        ...
        <div style="font-size: 3rem; margin-left: 3rem;">
            ...
            <div style="margin-top: 3rem;">
                <p>Documentador</p>
                <p style="margin-top: -7rem; margin-left: 55rem;">Cliente</p>
            </div>
        </div>
    @else
        ...
        <div style="text-align: center; border: .3px solid black;">
            <p style="margin-top: -.76rem; background: white; width: 45%; margin-left: 5rem;"><strong>Guía de Prepago</strong></p>
